package br.com.pizzaria.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		...
		.basePackage("br.com.pizzaria.controller"))
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder()
			...
			.licenseUrl("https://github.com/ProjetoPizzaria")
			.contact(contact())
			.build();
	}
	...
	private static Contact contact() {
		...
		return new Contact("Projeto Pizzaria", 
			"https://github.com/ProjetoPizzaria", 
			"pizzariaprojeto3@gmail.com");
